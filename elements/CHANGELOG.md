...
- [pos-literals](https://pod-os.org/reference/elements/components/pos-literals/): literal values can now be edited in place when the user has write access to the resource.
...
- [pos-switch](https://pod-os.org/reference/elements/components/pos-switch/) and [pos-case](https://pod-os.org/reference/elements/components/pos-case/): Added `ifProperty` and `ifRev` to test if resource is part of a specific forward or backward link
...
- [pos-app-dashboard](https://pod-os.org/reference/elements/apps/pos-app-dashboard/)
  - Now displays public and private type index entries in card-style containers

## 0.34.0

## Changed

- [pos-list](https://pod-os.org/reference/elements/components/pos-list):
