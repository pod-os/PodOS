...
describe('pos-value', () => {
  it('is empty initially', async () => {
    const page = await render(<pos-value predicate="https://vocab.example/#term" />);
    expect(page.root).toEqualHtml(`
      <pos-value predicate="https://vocab.example/#term" class="hydrated">
  ...
  it('renders property value from resource', async () => {
    ...
    expect(page.root.shadowRoot).toEqualHtml(`value of https://vocab.example/#term`);
  });
  ...
  it('updates property value when changed', async () => {
    ...
    await page.waitForChanges();
    expect(page.root.shadowRoot).toEqualHtml(`new value of https://vocab.example/#term`);
  });
  ...
  it('updates when resource changes', async () => {
    ...
    await page.waitForChanges();
    expect(page.root.shadowRoot).toEqualHtml(`value for first resource`);
    ...
    await page.waitForChanges();
    expect(page.root.shadowRoot).toEqualHtml(`value for second resource`);
  });
  ...
  it('updates when predicate changes', async () => {
    ...
    page.instance.predicate = 'https://vocab.example/#term2';
    await page.waitForChanges();
    expect(page.root.shadowRoot).toEqualHtml(`value of https://vocab.example/#term2`);
  });
});
